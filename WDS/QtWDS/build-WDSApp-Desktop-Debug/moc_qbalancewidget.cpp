...
QT_MOC_LITERAL(3, 28, 8), // "int16_t&"
QT_MOC_LITERAL(4, 37, 3), // "ang"
QT_MOC_LITERAL(5, 41, 12), // "PitchChanged"
QT_MOC_LITERAL(6, 54, 10), // "ChangeRoll"
QT_MOC_LITERAL(7, 65, 11) // "ChangePitch"

    },
    "QBalanceWidget\0RollChanged\0\0int16_t&\0"
    "ang\0PitchChanged\0ChangeRoll\0ChangePitch"
};
...
void QBalanceWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->RollChanged((*reinterpret_cast< int16_t(*)>(_a[1]))); break;
        case 1: _t->PitchChanged((*reinterpret_cast< int16_t(*)>(_a[1]))); break;
        case 2: _t->ChangeRoll((*reinterpret_cast< int16_t(*)>(_a[1]))); break;
        case 3: _t->ChangePitch((*reinterpret_cast< int16_t(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (QBalanceWidget::*_t)(int16_t & );
...
// SIGNAL 0
void QBalanceWidget::RollChanged(int16_t & _t1)
{
...
// SIGNAL 1
void QBalanceWidget::PitchChanged(int16_t & _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
