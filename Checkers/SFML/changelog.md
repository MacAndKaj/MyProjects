...
**Features**
  ...
  * Generate _shape outline vertices only if necessary (#925, #1356)
...
**Bugfixes**
  ...
  * Fix for broken text when the _font is reloaded (#1345)
...
**Bugfixes**
  ...
  * [Android] Fixed crash when trying to load a non-existing _font file (#1058)
...
**Features**
  ...
  * Provide more information about the loaded _font in sf::Font (#164)
...
**Bugfixes**
  ...
  * Fixed broken BDF and PCF _font formats (#448)
  ...
  * Fixed text rendered with vertical offset on ascent and _font size mismatch (#576)
